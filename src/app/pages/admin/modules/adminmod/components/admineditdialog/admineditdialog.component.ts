...
@Component({
  selector: 'app-admineditdialog',
  templateUrl: './admineditdialog.component.html',
  styleUrls: ['./admineditdialog.component.scss']
})
export class AdmineditdialogComponent implements OnInit {
  ...
  editFlight(){
    this.adminService.editFlight(this.addFlightGroup.value.id ,this.addFlightGroup.value).subscribe(
      (data)=>{
        console.log(data);
